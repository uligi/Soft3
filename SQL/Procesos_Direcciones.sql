...
AS
BEGIN
    SELECT d.DireccionID, d.Direccion, d.DireccionDetallada, 
...
BEGIN
    BEGIN TRY
        INSERT INTO Direcciones (Direccion, DireccionDetallada, ProvinciaID, CantonID, DistritoID, ClienteID)
        VALUES (@Direccion, @DireccionDetallada, @ProvinciaID, @CantonID, @DistritoID, @ClienteID)
